# Seed New Money University: branding settings, signup, outgoing email, example courses.
# Idempotent. Run inside the backend container:
#   docker compose -p new-money exec -T backend \
#     bench --site new-money.42bucks.com console < ops/seed_content.py
